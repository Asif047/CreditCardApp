    ...
    Column(
        ...
        Row(
            ...
            Box(modifier = Modifier.weight(1f)) {
                OutlinedTextFieldCardHolderName2 { value ->
                    cardNameText.value = value
                    visibleNameIcon.value = cardNameText.value.isNotEmpty()
                    Log.e("###ZZZ:", cardNameText.value) // This should print the value entered in the TextField
                }
            }
        ...
        Row(
            ...
            Box(modifier = Modifier.weight(1f)) {
                OutlinedTextFieldCardHolderName { value ->
                    cardIdText.value = value
                    print("###AAA: ${cardNameText.value}")
                    if(cardNameText.value.isNotEmpty()) {
                        visibleNameIcon.value = true
                    }
                }
            }
